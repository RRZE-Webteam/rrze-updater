    ...
    public function assets(string $hook): void
    {
        ...
        wp_localize_script('rrze-updater-bundles', 'rrzeUpdaterBundles', [
            ...
            'labels' => [
                ...
                'blocked' => __('Prerequisites need attention. Fix the listed errors and retry checks, or choose Install anyways to skip affected entries and their dependents.', 'rrze-updater'),
                ...
                'completeWithSkips' => __('Processing finished. Entries with prerequisite errors and their dependents were skipped. Run prerequisite checks again after fixing them.', 'rrze-updater'),
