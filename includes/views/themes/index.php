...
<h2>
    <?php esc_html_e('Themes', 'rrze-updater'); ?>
...
<?php
$bulkDeleteConfirmTitle = __('Delete selected theme repositories?', 'rrze-updater');
$bulkDeleteConfirmMessage = __('This action deletes the selected theme repository definitions from RRZE Updater. Installed themes are not removed by this bulk action.', 'rrze-updater');
$bulkDeleteConfirmCheckboxLabel = __('I understand that the selected theme repository definitions will be deleted.', 'rrze-updater');
