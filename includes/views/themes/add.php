...
?>
<h2><?php esc_html_e('Install Theme', 'rrze-updater'); ?></h2>

<form action="" method="POST">
    <?php wp_nonce_field('rrze-updater-theme-add', 'rrze-updater-nonce'); ?>
    <input type="hidden" name="rrze-updater[action]" value="add-theme">
    ...
    <?php submit_button(__('Install Theme', 'rrze-updater')); ?>
</form>
